...
import com.example.countries.domain.Translations;
...
public class Country implements Parcelable {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(name).append(capital).append(altSpellings).append(relevance).append(region).append(subregion).append(translations).append(population).append(latlng).append(demonym).append(area).append(gini).append(timezones).append(borders).append(nativeName).append(callingCodes).append(topLevelDomain).append(alpha2Code).append(alpha3Code).append(currencies).append(languages).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(name, rhs.name).append(capital, rhs.capital).append(altSpellings, rhs.altSpellings).append(relevance, rhs.relevance).append(region, rhs.region).append(subregion, rhs.subregion).append(translations, rhs.translations).append(population, rhs.population).append(latlng, rhs.latlng).append(demonym, rhs.demonym).append(area, rhs.area).append(gini, rhs.gini).append(timezones, rhs.timezones).append(borders, rhs.borders).append(nativeName, rhs.nativeName).append(callingCodes, rhs.callingCodes).append(topLevelDomain, rhs.topLevelDomain).append(alpha2Code, rhs.alpha2Code).append(alpha3Code, rhs.alpha3Code).append(currencies, rhs.currencies).append(languages, rhs.languages).isEquals();
    }
